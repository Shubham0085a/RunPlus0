            ...
            <div className=" w-auto lg:w-[43rem] flex flex-col gap-5">
              ...
              <div>
                <p className=" font-normal text-2xl">
                  ...
                  or cost your thousands. Runplus is purpose built for that
                </p>
              </div>
            </div>
            <div>
              <button className=" h-[4.688rem] w-[17.313rem] bg-white rounded-full font-medium text-2xl text-[#002548]">
                Join Our Team
              </button>
            </div>
          </div>
